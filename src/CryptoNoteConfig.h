...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 2712194;
...
/* Premine amount */
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(300000000000000);

const char     GENESIS_COINBASE_TX_HEX[]                     = "012801ff00018080bb8b939b440280a6eb3e8fb9ada34a327c2e54fd233453ef59db15d7bca3f46d81e83d14123b2101a7a246be34850e04e390191a4f3cc83817e5caf8e7616497c06e0dd04b2591f0";

/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in TurtleCoind. It is used to know what timestamp
   to import from when the block height cannot be found in the node or the node is offline. */
const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1535869993;
...
const char     CRYPTONOTE_NAME[]                             = "MIMI Money";
...
const char     LATEST_VERSION_URL[]                          = "https://www.mimi.money";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0x6f, 0x69, 0x6b, 0x65, 0x4e, 0x73, 0x65, 0x72, 0x65, 0x6b, 0x6f, 0x4e, 0x69, 0x4d, 0x69, 0x73  }
};

const char* const SEED_NODES[] = {
  "178.238.232.123:39699", //Main
  "79.143.186.127:39699" // EU 
  "173.249.42.102:39699" // Mi 
  "173.212.216.180:39699" // Mo 
  "167.86.87.136:39699" // Cache
  "173.212.227.98:39699" // US
};
} // CryptoNote
